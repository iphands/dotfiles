;;; js2-highlight-vars-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
`Js2-Highlight-vars mode' mode.  If the prefix argument is positive,
...
evaluate the variable `js2-highlight-vars-mode'.
...
(provide 'js2-highlight-vars-autoloads)
